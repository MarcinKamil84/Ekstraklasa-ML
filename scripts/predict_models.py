...
final_best_goals_model = load_model('./models/goals_final')
...
goals_predictions = predict_model(final_best_goals_model, data=ekstraklasa_test)
...
results_df['dom'] = goals_predictions['team']
results_df['wyjazd'] = goals_predictions['opponent']

results_df['punkty'] = points_predictions['Label']
results_df['punkty_score'] = round(points_predictions['Score'], 2)

results_df['bramki_dom'] = goals_predictions['Label']
results_df['bramki_dom_score'] = round(goals_predictions['Score'], 2)

results_df['home_or_away'] = goals_predictions['home_or_away']
